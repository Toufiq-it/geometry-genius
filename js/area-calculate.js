...
function calculateEllipseArea() {
    const firstRadius = getInputValue('ellipse-first-redues');
    const secoundRadius = getInputValue('ellipse-secound-redues');
    const area = 3.1416 * firstRadius * secoundRadius;
